// lib/screens/nav/goat/widgets/event_specific_fields.dart
...
class HistorySpecificFieldsState extends State<HistorySpecificFields> {
  ...
  void initState() {
    super.initState();
    // Initialize Kid data from parent if available
    if (widget.temporaryKidData != null) {
  ...
  void didUpdateWidget(HistorySpecificFields oldWidget) {
    ...
    // Update Kid data when parent updates it
    ...
    switch (widget.selectedEventType.toLowerCase()) {
      ...
      case 'gives birth':
        return GivesBirthEventFields(
          ...
          onEditKidPressed: widget.onEditKidPressed,
          onKidDataChanged: updateKidData,
        );
  ...
  Map<String, dynamic>? getNewKidData() {
    return _newKidData;
  }

  bool hasKidData() {
    return _newKidData != null;
  }

  String? getKidTag() {
    return _newKidData?['tag_no'];
  }

  Map<String, dynamic>? getFullKidData() {
    return _newKidData?['fullKidData'];
  }

  bool isKidReadyForRegistration() {
    return _newKidData != null &&
        _newKidData!['fullKidData'] != null &&
        _newKidData!['pendingOperation'] != null;
  }
