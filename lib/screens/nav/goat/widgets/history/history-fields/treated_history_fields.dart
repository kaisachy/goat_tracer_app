// lib/screens/nav/goat/widgets/event_fields/treated_event_fields.dart
...
class TreatedEventFieldsState extends BaseEventFieldsState<TreatedEventFields> {
  ...
  Future<void> _prefillDiseaseTypeFromLatestSickEvent() async {
    final tag = widget.goatTag?.trim();
    if (tag == null || tag.isEmpty) return;
    setState(() => _loadingDisease = true);
    try {
      final events = await GoatHistoryService.getgoatHistoryByTag(tag);
      events.sort((a, b) {
