...
class HistorySearchFilterBar extends StatefulWidget {
  ...
  @override
  State<HistorySearchFilterBar> createState() => _HistorySearchFilterBarState();
}

class _HistorySearchFilterBarState extends State<HistorySearchFilterBar> {
